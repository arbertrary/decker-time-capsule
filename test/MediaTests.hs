...
plainImageCaptionedHtml =
  RawInline
    (Format "html")
    "<figure id=\"logo\" class=\"decker myclass\" data-myattribute=\"1\" style=\"width:30%;border:1px;\"><img class=\"decker\" data-src=\"include/06-metal.png\" alt=\"06-metal.png\"><figcaption class=\"decker\">A <strong>logo.</strong></figcaption></figure>"
