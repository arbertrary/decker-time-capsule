    ...
    function loadPlugin() {
      ...
      if (initialise) {
        ...
        function reenableMouseSelection() {
          ...
          select("nav.slide-menu").addEventListener(
            "mousemove",
            function fn(e) {
        ...
        function init() {
          if (!initialised) {
            ...
            let animButton = addToolbarButton(
              "Animations",
              "Animations",
              Reveal.getConfig().fragments ? "fa-check-circle" : "fa-circle",
              "far",
              function () {
            ...
            // MARIO: show/hide whiteboard
            let whiteboardButton = addToolbarButton(
              "Annotations",
              "Annotations",
              "fa-check-circle",
              "far",
              function () {
                const reveal = select(".reveal");
                const icon = whiteboardButton.firstChild;
                const hide = !reveal.hasAttribute("data-hide-whiteboard");
                if (hide) reveal.setAttribute("data-hide-whiteboard", "true");
                else reveal.removeAttribute("data-hide-whiteboard");
                icon.classList.remove("fa-circle-check", "fa-circle");
                icon.classList.add(hide ? "fa-circle" : "fa-circle-check");
              },
              true
            );
